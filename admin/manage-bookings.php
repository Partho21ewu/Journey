...
?>
	...
	<head>
		<title>JOURNEY | Admin Manage Bookings</title>
					...
					<div class="agile-tables">
						<div class="w3l-table-info">
							...
							<table id="table">
								...
								<tbody>
									<?php $sql = "SELECT booking.BookingId as bookid,users.name as fname,booking.Phone as mnumber,users.email as email,tbltourpackages.PackageName as pckname,booking.PackageId as pid,booking.status as status,booking.CancelledBy as cancelby from users join  booking on  booking.Email=users.email join tbltourpackages on tbltourpackages.PackageId=booking.PackageId";
									$query = $dbh->prepare($sql);
									$query->execute();
