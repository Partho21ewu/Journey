...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		move_uploaded_file($_FILES["packageimage"]["tmp_name"], "packageimages/" . $myname);

		$sql = "INSERT INTO tbltourpackages (PackageName, PackageType, PackageLocation, PackagePrice, PackageFetures, PackageDetails, PackageImage) VALUES (:pname, :ptype, :plocation, :pprice, :pfeatures, :pdetails, :myname)";
...
?>
	...
	<head>
		<title>JOURNEY | Admin Package Creation</title>
						...
						<div class="tab-content">
							<div class="tab-pane active" id="horizontal-form">
								<form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">Package Price in Takas</label>
										<div class="col-sm-8">
											<input type="text" class="form-control1" name="packageprice" id="packageprice" placeholder=" Package Price is Takas" required>
										</div>
									</div>
