   ...
   <div id="page" class="page">
      ...
      <main id="content" class="site-main">
         ...
         <section class="home-banner-section home-banner-slider">
            <div class="home-banner d-flex flex-wrap align-items-center" style="background-image: url(https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D);">
                  ...
                  ?>
                        <article class="package-item">
                           ...
                           <div class="package-price">
                              ...
                              <h6 class="price-list">
                                 <span>BDT<?php echo htmlentities($result->PackagePrice); ?></span>
                                 / per person
                              </h6>
