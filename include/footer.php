<footer id="colophon" class="site-footer footer-primary">
                        ...
                        <div class="col-lg-3 col-sm-6">
                           <aside class="widget widget_text">
                              <div class="footer-logo">
                                 <a href="index-2.php"><img src="assets/images/1log.png" alt=""></a>
                              </div>
                                 ...
                                 <ul>
                                    ...
                                    <li>
                                       <a >
                                        ...
                                        service.tourtrack@gmail.com  
                                       </a>
                                    </li>
                                    <li>
                                       <i aria-hidden="true" class="icon icon-map-marker1"></i>
                                       Aftabnagar Block-A Road-1, Dhaka Bangladesh 
                                    </li>
                                 </ul>
                              </div>
                           </aside>
            ...
            <div class="bottom-footer">
               <div class="container">
                  <div class="copy-right text-center">Copyright &copy; 2023 JOURNEY. All rights reserved.</div>
               </div>
            </div>
         </footer>
